...
function help_panel() {
    ...
    echo -e "${blue_bold_color}-p, --password              ${end_color}${white_bold_color}Password${end_color}"
    echo -e "${blue_bold_color}-f, --function              ${end_color}${white_bold_color}Function to execute${end_color}"

    echo -e "\n    ${blue_bold_color}users                   ${end_color}${white_bold_color}Enumerate users${end_color}"
    echo -e "    ${blue_bold_color}querydispinfo           ${end_color}${white_bold_color}Enumerate deployment users' information${end_color}"
    echo -e "    ${blue_bold_color}users_info              ${end_color}${white_bold_color}Enumerate users' information${end_color}"
    echo -e "    ${blue_bold_color}groups                  ${end_color}${white_bold_color}Enumerate groups${end_color}"
    echo -e "    ${blue_bold_color}groups_and_users        ${end_color}${white_bold_color}Enumerate groups and their members${end_color}"
    echo -e "    ${blue_bold_color}printers                ${end_color}${white_bold_color}Enumerate printers${end_color}"
    echo -e "    ${blue_bold_color}shares                  ${end_color}${white_bold_color}Enumerate SMB shares${end_color}"
    echo -e "    ${blue_bold_color}password_policy         ${end_color}${white_bold_color}Enumerate password policy${end_color}"
    echo -e "    ${blue_bold_color}server_info             ${end_color}${white_bold_color}Enumerate server information${end_color}"
